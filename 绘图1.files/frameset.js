...
var xmlData = XMLData("绘图1.files/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='此表包含形状的详细信息'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>标签</TH><TH>值</TH></THEAD>";
